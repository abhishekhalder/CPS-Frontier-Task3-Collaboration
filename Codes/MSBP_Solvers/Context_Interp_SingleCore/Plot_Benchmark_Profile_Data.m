%% Description
%
% Given a benchmark name and context, plot corresponding 3D profile data
%
%==========================================================================
close all; clear; clc;
...
% dfile_pfix = sprintf("../%s_outfiles/marginals_additional/%s_",BENCHMARK_NAME,BENCHMARK_NAME);
...
%% Plot
%==========================================================================
f = figure('color','white','Position',[100 100 2000 600]);
% ax = axes('Parent', f);
sph = [];
...
for k=1:numMarginal_Time
    ...
    hold on;
%     if (k==3) xlabel("Instructions retired", 'FontSize', 30); end
%     if (k==1) ylabel("Cache requests", 'FontSize', 30); end
%     if (k==1) zlabel("Cache misses", 'FontSize', 30); end
    if (k==1) 
