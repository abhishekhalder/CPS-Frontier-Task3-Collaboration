...
%==========================================================================
dfile_pfix = sprintf("../%s_no_perf_duplexing_outfiles/marginals/%s_",BENCHMARK_NAME,BENCHMARK_NAME);
...
%==========================================================================
out_dir    = sprintf("./data_out/%s_no_perf_duplexing_synth_profiles/", BENCHMARK_NAME);
