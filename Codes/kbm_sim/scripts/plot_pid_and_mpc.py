#
# Superimpose data output by PID and MPC controllers
#
...
for line in open(INFILE_PID, 'r'):
	lines = [i for i in line.split()]
	t_pid.append(float(lines[0]))
	x_pid.append(float(lines[1]))
	y_pid.append(float(lines[2]))
	yaw_pid.append(float(lines[3]))
	v_pid.append(float(lines[4]))
	throttle_pid.append(float(lines[5]))
	delta_pid.append(float(lines[6]))
...
axis1[0].plot(t, x, marker = 'None', c = 'b', linewidth=2, label="MPC")
axis1[0].plot(t_pid, x_pid, marker = 'None', c = 'r', linewidth=2, label="PID")
axis1[0].legend()
axis1[0].set_title("Vehicle x position (m)")
axis1[0].set_xlabel('t (s)')
axis1[0].set_ylabel('x (m)')

axis1[1].plot(t, y, marker = 'None', c = 'b', linewidth=2, label="MPC")
axis1[1].plot(t_pid, y_pid, marker = 'None', c = 'r', linewidth=2, label="PID")
axis1[1].legend()
axis1[1].set_title("Vehicle y position (m)")
axis1[1].set_xlabel('t (s)')
axis1[1].set_ylabel('y (m)')

axis1[2].plot(t,yaw, marker = 'None', c = 'b', label="MPC")
axis1[2].plot(t_pid,yaw_pid, marker = 'None', c = 'r', label="PID")
axis1[2].legend()
axis1[2].set_title("Vehicle yaw (rads)")
axis1[2].set_xlabel('t (s)')
axis1[2].set_ylabel('yaw (rads)')

axis1[3].plot(t,v, marker = 'None', c = 'b', label="MPC")
axis1[3].plot(t_pid,v_pid, marker = 'None', c = 'r', label="PID")
axis1[3].legend()
axis1[3].set_title("Vehicle speed (m/s)")
axis1[3].set_xlabel('t (s)')
axis1[3].set_ylabel('v (m/s)')

figure1.savefig('./plots/figure_1_comb.png', dpi=100)
...
axis2[0].plot(t, throttle, marker = 'None', c = 'b', linewidth=2, label="MPC")
axis2[0].plot(t_pid, throttle_pid, marker = 'None', c = 'r', linewidth=2, label="PID")
axis2[0].legend()
axis2[0].set_title("Vehicle throttle")
axis2[0].set_xlabel('t (s)')
axis2[0].set_ylabel('throttle ($m/s^2$)')

axis2[1].plot(t, delta, marker = 'None', c = 'b', linewidth=2, label="MPC")
axis2[1].plot(t_pid, delta_pid, marker = 'None', c = 'r', linewidth=2, label="PID")
axis2[1].legend()
axis2[1].set_title("Vehicle steering")
axis2[1].set_xlabel('t (s)')
axis2[1].set_ylabel('steering (rad/s)')

figure2.savefig('./plots/figure_2_comb.png', dpi=100)
...
axis3.plot(x, y, marker = 'o', c = 'r', linewidth=1, label="MPC")
axis3.plot(x_pid, y_pid, marker = '1', c = 'g', linewidth=1, label="PID")
axis3.plot(x_tr, y_tr, marker = 'None', c = 'k', linewidth=1, label="Target trajectory")
axis3.legend()
axis3.set_xlabel('x (m)')
axis3.set_ylabel('y (m)')

figure3.savefig('./plots/figure_3_comb.png', dpi=100)
