...
dfile_pfix = "../halder_outfiles_0927_intermarginals4/kbm_sim_32767_1080_0_t";
...
% l = 5;              % Interpolate between t_l and t_{l+1}
num_interp = 5;     % Number of locations to interpolate at.
...
for k=1:num_interp
    ...
    addD{k} = readmatrix("../halder_outfiles_0927_intermarginals5/kbm_sim_32767_1080_0_t" + num2str((num_interp+1)*(l-1)+k) + "_3dim.txt");
