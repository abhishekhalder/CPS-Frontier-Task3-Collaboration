...
NUM_STDS = 0 
NUM_INTERMEDIATE = 5                        # number of marginals to get between cycle end times
INPATH   = "../../Data/kbm_sim_profile/"
# OUTPATH  = "./halder_outfiles_0927/"
# OUTPATH  = "./halder_outfiles_0927_intermarginals/"
# OUTPATH  = "./halder_outfiles_0927_intermarginals0/"
# OUTPATH  = "./halder_outfiles_0927_intermarginals1/"
# OUTPATH  = "./halder_outfiles_0927_intermarginals2/"
# OUTPATH  = "./halder_outfiles_0927_intermarginals3/"
# OUTPATH  = "./halder_outfiles_0927_intermarginals4/"
OUTPATH  = "./halder_outfiles_0927_intermarginals5/"
###################
KDE_KERNEL = "gaussian"
###################
...
ax.set_title(r'End times for all control cycles $\mid$ $\mathbf{c}=\left[%d, %d, y_{\rm{des}}^{%d}(x)\right]^{\top}$' % (15, 15, (PATHNO+1)))
...
for j in range(NUM_RUNS):
    ...
    for line in open(curr_file, 'r'):
        ...
        xi = [ float(splt[2]), float(splt[3])+float(splt[4]), float(splt[5]) ] # Combining LLC loads and stores
...
# axs[2].set_title("LLC Misses")
# ##############################

## Write the needful to file ##
###############################
for i in range(len(xi_vals)):
    outfile = OUTPATH + "kbm_sim_"+str(CACHE)+"_"+str(MEMBW)+"_"+str(PATHNO)+"_t"+str(i)+"_3dim.txt"
    ...
    with open(outfile, 'w') as f:
        for j in range(len(xi_vals[i])):
            ...
            f.write("%f %f %f\n" % (xi_vals[i][j][0], xi_vals[i][j][1], xi_vals[i][j][2]))
###############################
