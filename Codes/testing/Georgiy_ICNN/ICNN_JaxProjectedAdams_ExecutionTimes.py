...
#   f: (Cache,MemBW,PathID) \mapsto Execution time
#
...
dim_hidden = [3,50,100,100,50,5] # dimensions to be used by ICNN_Jax (see below)
num_epochs = 10
batch_size = 1
...
data=pd.read_csv(data_dir + 'execution_time_data.txt')
Y=data.pop('etime') 
X=data
